def bottle_song():
    ...
    # if bottles is zero return Take one down and pass it around, no more bottles of beer on the wall. 
    # No more bottles of beer on the wall, no more bottles of beer.Go to the store and buy some more, 99 bottles of beer on the wall.
    	...
    	if x == 0 :
        	...
        	print("1 bottle of beer on the wall. 1 bottle of beer on the wall. Take one down and pass it around, no more bottles of beer on the wall.")
